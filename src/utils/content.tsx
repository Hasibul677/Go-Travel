...
const navigationLinks: NavigationLink[] = [
  ...
  },
  {
    ...
    dropdownLinks: [
      ...
      {
        id: 2,
        to: "/destinationExpertise",
        text: "Destination Expertise",
        dropdown: false,
      },
      {
        id: 3,
        to: "/customizedPackages",
...
const footerCols: FooterCol[] = [
  {
    ...
    links: [
      { id: 1, to: "#", name: "Blog" },
      { id: 2, to: "#", name: "Explore" },
      { id: 3, to: "#", name: "VIP Program" },
  ...
  },
  {
    ...
    heading: "Services",
    links: [
      { id: 1, to: "#", name: "Culinary" },
      { id: 2, to: "#", name: "Location" },
      { id: 3, to: "#", name: "Destination" },
      { id: 4, to: "#", name: "Customizes" },
    ],
  },
  {
    id: 3,
    heading: "Extra",
    links: [
      { id: 1, to: "#", name: "Privacy Policy" },
      { id: 2, to: "#", name: "About Company" },
      { id: 3, to: "#", name: "Payment Gateway" },
      { id: 4, to: "#", name: "Terms & Conditions" },
    ],
  },
  {
    id: 4,
    ...
    links: [
      { id: 1, to: "#", Icon: Phone, name: "1 248 416 6573" },
      { id: 2, to: "#", Icon: Email, name: "gotravel@gmail.com" },
      { id: 3, to: "#", Icon: LocationIcon, name: "25 East 29th Street, NY" },
    ],
  },
];
